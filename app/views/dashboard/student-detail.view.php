    ...
    <div class="row">
        <div class="col">
            <div class="mb-4 d-flex justify-content-between">
                <h1 class="h3 text-gray-800">Detail Siswa</h1>
                <div>
                    <button data-toggle="modal" data-target="#bayarModal" class="btn btn-info" style="height: max-content;">Bayar SPP</button>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mt-2 font-weight-bold text-info">Detail Siswa</h6>
                        </div>
                        <div class="card-body">
                            <table>
                                <tr>
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="mt-2 font-weight-bold text-info">History</h6>
                        </div>
                        <div class="card-body">
